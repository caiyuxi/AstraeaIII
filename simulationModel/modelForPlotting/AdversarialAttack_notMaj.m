function [expectedScoreSt,expectedScoreSf, PrTrueAsMajority,PrFalseAsMajority] = AdversarialAttack_notMaj(PrT1,PrStT1,PrStT2,PrTrue,n,p)
...
%portion of true report and false report
PrTrue = PrTrue*(1-p);
PrFalse = PrFalse * p;
...
expectedScoreSt = PrTrueAsMajority * ... % true as majority
                        (PrTrue * quadraticScoringRule(1,findYPrim(1,ySt) + PrFalse * quadraticScoringRule(1,findYPrim(0,ySt))) ...
                         + PrFalse * quadraticScoringRule(1,findYPrim(1,ySf) + PrFalse * quadraticScoringRule(1,findYPrim(0,ySf))) ...
