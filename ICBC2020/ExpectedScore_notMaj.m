function [expectedScoreSt,expectedScoreSf, PrTrueAsMajority,PrFalseAsMajority] = ExpectedScore_notMaj(PrT1,PrStT1,PrStT2,PrTrue,n)
...
% u_i = |Report_T|/n * 
%               ((|Report_T|/n * Rq(findYPrim(xi,yjT), 1) + |Report_F|/n * Rq(findYPrim(xi,yjF), 1)) 
%       +|Report_F|/n * 
%               ((|Report_T|/n * Rq(findYPrim(xi,yjT), 0) + |Report_F|/n * Rq(findYPrim(xi,yjF), 0))
%       + Rq(yi,xk)
    % xk: majority;
...
expectedScoreSt = ... % information score
                      (PrTrue * (PrTrue * quadraticScoringRule(1,findYPrim(1,ySt)) + PrFalse * quadraticScoringRule(0,findYPrim(1,ySt))) ...
                         + PrFalse * (PrTrue * quadraticScoringRule(1,findYPrim(1,ySf)) + PrFalse * quadraticScoringRule(0,findYPrim(1,ySf)))) ...
                  ... % prediction score
                      + (PrTrueAsMajority * quadraticScoringRule(1,ySt) ... % true as majority
                      + PrFalseAsMajority * quadraticScoringRule(0,ySt) ...% false as majority
                      + (1 - PrTrueAsMajority - PrFalseAsMajority) * ...% if no majority, pick another voter as reference
                            (PrTrue * quadraticScoringRule(1,ySt) ...
                            + PrFalse * quadraticScoringRule(0,ySt)));
expectedScoreSf = ... % information score
                      (PrTrue * (PrTrue * quadraticScoringRule(1,findYPrim(0,ySt)) + PrFalse * quadraticScoringRule(0,findYPrim(0,ySt))) ...
                         + PrFalse * (PrTrue * quadraticScoringRule(1,findYPrim(0,ySf)) + PrFalse * quadraticScoringRule(0,findYPrim(0,ySf)))) ...
                  ... % prediction score
                      + (PrTrueAsMajority * quadraticScoringRule(1,ySf) ... % true as majority
                      + PrFalseAsMajority * quadraticScoringRule(0,ySf) ...% false as majority
                      + (1 - PrTrueAsMajority - PrFalseAsMajority) * ...% if no majority, pick another voter as reference
                            (PrTrue * quadraticScoringRule(1,ySf) ...
                            + PrFalse * quadraticScoringRule(0,ySf)));
end
